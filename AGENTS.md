...
- **Stack:** Next.js 16 App Router (RSC) + TypeScript + Tailwind CSS v4 + `motion` + `@phosphor-icons/react` + `sonner`.
...
- **Copy is Romanian (`ro`)** and comes from the product ad — do not rewrite or invent new marketing claims.
